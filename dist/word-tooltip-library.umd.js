(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.WordTooltipLibrary = {}));
  ...
  function fetchMeaning(_x) {
    return _fetchMeaning.apply(this, arguments);
  }

  // Function to handle mouse hover
  function _fetchMeaning() {
    _fetchMeaning = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(word) {
      var response, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            data = _context.sent;
            return _context.abrupt("return", data[0].meanings[0].definitions[0].definition);
          case 10:
            _context.prev = 10;
            _context.t0 = _context["catch"](0);
            return _context.abrupt("return", "No definition found");
          case 13:
          case "end":
  ...
  function handleHover(event, tooltip) {
    ...
    fetchMeaning(word).then(function (meaning) {
      tooltip.textContent = meaning;
      tooltip.style.display = 'block';
      tooltip.style.left = "".concat(event.pageX + 10, "px"); // Adjust position near the mouse
  ...
  function initializeWordTooltips(selector, tooltipId) {
    ...
    words.forEach(function (word) {
      word.addEventListener('mouseenter', function (event) {
        return handleHover(event, tooltip);
      });
      word.addEventListener('mouseleave', function () {
        return handleLeave(tooltip);
      });
    });
  }

  exports.fetchMeaning = fetchMeaning;
  exports.handleHover = handleHover;
  exports.handleLeave = handleLeave;
  exports.initializeWordTooltips = initializeWordTooltips;
